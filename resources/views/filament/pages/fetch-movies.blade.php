    ...
    <div class="p-6">
        <div>
            ...
            <div class="mt-6">
                ...
                <textarea class="w-full p-3 bg-transparent border rounded" style="height: 12rem;">{{ implode(
                    "\n",
                    array_map(
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                    ...
                    <textarea class="w-full bg-transparent  p-3 border rounded" style="height: 12rem;" readonly>@php
                        echo implode("\n", $successMovies ?? []);
                    @endphp</textarea>
                </div>
                <div>
                    <h2 class="text-lg font-bold">Danh sách phim thất bại</h2>
                    <textarea class="w-full p-3 bg-transparent border rounded" style="height: 12rem;" readonly>@php
                        echo implode("\n", $failedMovies ?? []);
                    @endphp</textarea>
                </div>
            </div>
